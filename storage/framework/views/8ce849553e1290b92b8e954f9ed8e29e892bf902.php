                        ...
                        <div class="card-header bg-white border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    ...
                                    <?php endif; ?>
                                    <?php if(!config('settings.is_pos_cloud_mode')&&!config('app.issd')): ?>
                                        <?php if(config('settings.wildcard_domain_ready')): ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Orders')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\dockerproject\homefood\resources\views/restorants/edit.blade.php ENDPATH**/ ?>