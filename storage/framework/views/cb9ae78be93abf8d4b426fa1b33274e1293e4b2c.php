...
<div class="card-body">
    ...
    <?php endif; ?>
     ...
     <?php endif; ?>
     <hr />
     <h3><?php echo e(__("TOTAL")); ?>: <?php echo money($order->delivery_price+$order->order_price_with_discount, $currency,true); ?></h3>
     <hr />
 ...
 </div><?php /**PATH O:\dockerproject\homefood\resources\views/orders/partials/orderinfo.blade.php ENDPATH**/ ?>