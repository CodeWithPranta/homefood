...
function initTheTrackingMap(currentPosiotion,){
  ...
  var marker = new google.maps.Marker({
    ...
    map: map,
    icon: end,
    title: '<?php echo e($order->client?$order->client->name:$order->getConfig("client_name","")); ?>'
  });
...
<style type="text/css">
  ...
  </style><?php /**PATH O:\dockerproject\homefood\resources\views/orders/partials/map.blade.php ENDPATH**/ ?>