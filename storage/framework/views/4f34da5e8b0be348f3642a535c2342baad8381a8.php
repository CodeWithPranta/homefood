                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    ...
                                                    <?php if($hasCloner): ?>
                                                     <a class="dropdown-item" href="<?php echo e(route('admin.restaurants.create')."?cloneWith=".$restorant->id); ?>"><?php echo e(__('Clone it')); ?></a>
                                                    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurants')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH O:\dockerproject\homefood\resources\views/restorants/index.blade.php ENDPATH**/ ?>